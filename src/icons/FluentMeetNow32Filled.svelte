<script lang="ts" module>
  export interface FluentMeetNow32FilledProps {
    display?: boolean;
    occupy?: boolean;
    size?: number;
    class?: string;
...
<script lang="ts">
  const {display = false, occupy = true, size = 0.7, class: className = ''}: FluentMeetNow32FilledProps = $props();
</script>
